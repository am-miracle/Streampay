        ...
        <table className="w-full">
          <thead className="bg-zinc-800/50">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold text-zinc-400">Ended</th>
            </tr>
          </thead>
              ...
              <tr key={item.id} className="hover:bg-zinc-800/30 transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-sm">{item.viewer}</span>
                  </div>
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono font-semibold text-mint-400">{item.earned}</span>
                  </div>
                </td>
